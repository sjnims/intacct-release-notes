---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_3/Cash_Management/2024-R3-CAD-pre-printed-check.htm
release: 2024-R3
extracted: 2026-02-07
title: "Print preprinted Canadian checks on any portion of the check"
---

# Print preprinted Canadian checks on any portion of the check
...
For increased flexibility, you can now print Canadian checks on either the top, middle, or bottom portion of the check stock. Previously, you could only print Canadian checks on the top portion of the check.
