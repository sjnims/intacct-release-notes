---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_4/Cash_Management/2024-R4-CAD-pre-printed-check.htm
release: 2024-R4
extracted: 2026-02-07
title: "New printing format option for preprinted Canadian checks"
---

# New printing format option for preprinted Canadian checks

[Set up preprinted Canadian checks](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=cad_check_printing_set_up)

cash management

Use our new Printing format for preprinted Canadian checks, CAD check 2.0, to adhere to the CPA-006 specification for Canadian business checks. This printing format is compatible with Top, Middle, and Bottom paper formats.
