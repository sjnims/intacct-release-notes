---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2025/2025_Release_3/Accounts_Payable/2025-R3-ap-pay-from-vendors-list.htm
release: 2025-R3
extracted: 2026-02-07
title: "Pay bills from the Vendors list"
---

# Pay bills from the Vendors list

[Pay a vendor from the Vendors list](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Pay_from_vendors_list)

Accounts Payable

Pay a vendor directly from the Vendors list without interrupting your workflow, using the **Pay** option.

![""](https://www.intacct.com/ia/docs/en_US/releasenotes/Resources/Images/2025/2025-R3-images/2025-R3-ap-pay-from-list.png)
