---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2025/2025_Release_3/Inventory___Supplies/2025-R3-Fulfill-partial.htm
release: 2025-R3
extracted: 2026-02-07
title: "Add flexibility to your order fulfillment workflow"
---

# Add flexibility to your order fulfillment workflow

[Fulfillment overview](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=FF_about_fulfillment)

[Picking orders](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Manage_orders_picking)
...
With more flexible and responsive order processing functionality, you can fully leverage fulfillment actions for all your warehouse team operations.

**Warehouse Managers** can streamline workflows by processing available items without delay. This allows the warehouse team to pick and ship available inventory even when the full quantity is not in stock.
...
![Original order quantity](https://www.intacct.com/ia/docs/en_US/releasenotes/Resources/Images/2025/2025-R3-images/2025-R3-INV-FulfillSplit-Track.png)
