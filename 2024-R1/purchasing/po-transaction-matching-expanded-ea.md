---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_1/Purchasing/2024-R1-po-transaction-matching-expanded-ea.htm
release: 2024-R1
extracted: 2026-02-07
title: "Automated transaction matching for Purchasing workflows—expanded Early Adopter Program"
---

# Automated transaction matching for Purchasing workflows—expanded Early Adopter Program
...
We're expanding our Early Adopter program as we extend functionality to include line-level matching. Interested in discovering how automated transaction matching can make your workflow more efficient? [Apply to become an Early Adopter](https://forms.office.com/r/tTthb1cGKs).
...
| Permissions           | Accounts Payable permissions Automated transactions: List Bills: Add (to change a draft transaction to an AP bill) Purchasing permissions (to view or edit the emailed transactions) Purchasing transactions: View, Edit                                                                                                                                                                              |
