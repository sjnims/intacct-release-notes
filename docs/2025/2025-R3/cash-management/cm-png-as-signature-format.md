---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2025/2025_Release_3/Cash_Management/2025-R3-cm-png-as-signature-format.htm
release: 2025-R3
extracted: 2026-02-07
title: "Upload digital signatures in PNG file format for use on checks"
---

# Upload digital signatures in PNG file format for use on checks

[Upload a check signature for a checking account](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Upload_check_signature_on_account)

[Upload a check signature on the Preferences page](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Upload_check_signature_preferences)
...
A digital signature is a scanned, digital image of your signature that's used to print a signature at the bottom of checks. Digital signatures can be used on checks that you print yourself and on checks sent through a payment service.
