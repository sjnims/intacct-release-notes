---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_1/Time_Expenses/2024-R1-SIT-enhancements.htm
release: 2024-R1
extracted: 2026-02-07
title: "Sage Intelligent Time enhancements"
---
...
We've added a print functionality for timesheets, introduced filtering and sorting for improved usability, added Construction dimensions, and upgraded the smart time entry experience. These features are available for both the embedded—Early Adopter and standalone versions of Sage Intelligent Time, unless otherwise specified.

## Print timesheets

You can now easily download and print timesheets to have physical copies for your records or for submission.

The Print timesheets feature is only available for the embedded version of Sage Intelligent Time.

To print, timesheets must have at least 1 time entry and be synced to Intacct or submitted. Admins can sync draft timesheets to Intacct to make drafts available for printing.
...
On the My Timesheets or Staff Timesheets pages, users can now filter and sort columns to quickly find the timesheets they need. Additionally, when viewing a timesheet, users can sort the time entry columns.
...
[What's the Time Assistant?](https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_1/Time_Expenses/2024-R1-SIT-enhancements.htm#)

The Time Assistant is a desktop application that captures the time you spend on your computer. It collects which applications are active, the name of the window or tab, and timestamps. SIT uses this information to create activity cards that you can choose to add to your timesheet. It does not collect any keystrokes you make, your location, or any other data.
