---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_3/Reporting-Advanced/2024-R3-New-ICRW-Report-Library-reports.htm
release: 2024-R3
...
[Video title (0.00)](https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_3/Reporting-Advanced/2024-R3-New-ICRW-Report-Library-reports.htm#)
...
ICRW requires a separate subscription. To purchase or enable an ICRW subscription, [contact your Sage Intacct account manager](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Contact_your_account_manager).
...
| Subscription                       | Interactive Custom Report Writer Construction Customization Services OR Platform Services                                                                                           |
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Regional availability              | ICRW: Any Construction: United States, Canada, Australia, United Kingdom                                                                                                            |
| Permissions                        | ICRW: Run, View, List, Add, Edit, Delete                                                                                                                                            |
