---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2024/2024_Release_3/Tax/2024-R3-T5018-GA.htm
release: 2024-R3
extracted: 2026-02-07
title: "T5018 for Canada—Generally available"
---

# T5018 for Canada—Generally available

[T5018 for Canada](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=Overview_of_T5018)

[Canada Revenue Agency (CRA)](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/completing-filing-information-returns/t5018-slip-statement-contract-payments.html#h-4)

Taxes

If you operate a Canadian company or entity that's required to report payments made to contractors, you can now generate a T5018 XML file in Sage Intacct. With T5018 information in Intacct, you can quickly and easily file your T5018 with the Canadian Revenue Agency (CRA).
...
6. Export to XML.
7. Use the CRA's Internet File Transfer method to upload the data captured and file your T5018 with the CRA.
...
| Restrictions          | The T5018 is for companies or entities that operate in Canada. Advances are included in the T5018. Credits are not included. Internet File Transfer is the supported CRA upload method. |
