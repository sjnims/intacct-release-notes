---
source: https://www.intacct.com/ia/docs/en_US/releasenotes/2025/2025_Release_2/Tax/2025-R2-tax-solution-SG.htm
release: 2025-R2
extracted: 2026-02-07
title: "Support for taxes in Singapore—Early Adopter"
---

# Support for taxes in Singapore—Early Adopter
...
To facilitate tax calculation and reporting, we added a Singapore tax solution to our list of standard tax solutions. The Singapore tax solution provides an automated setup for the tax rates for domestic GST in Singapore.

When you install the Singapore tax solution in one or more entities, you can generate tax submissions using our manual tax submission process.

## Details

The Singapore standard tax solution provides pre-configured tax details and tax schedules for Singapore domestic GST that you can use in your company or entities. To take full advantage of this setup, you must create your own Contact tax groups, Item tax groups, and Tax schedule maps. [Learn more about creating custom tax objects for a tax solution](https://www.intacct.com/ia/docs/en_US/help_action/Default.htm#cshid=TOC_Tax_Objects).

When you create a tax submission in an entity using the Singapore tax solution, you can track transactions that are included for a selected period and then run reports to extract the data needed for filing. After you complete your manual submission, you can mark the submitted transactions as filed.

Users must **Turn off tax detail filtering** and **Enable override of tax schedule on document entry** in Order Entry and Purchasing to use the Singapore tax solution.
...
The Early Adopter program provides Singapore tax support to users of the Taxes application. As an early adopter, you can influence how we develop the product so that our product meets your business needs.
...
| Subscription          | Taxes                                                                                             |
| --------------------- | ------------------------------------------------------------------------------------------------- |
| Regional availability | Australia Singapore                                                                               |
